...
outcome of the homicide investigation.
...
![](p8105_hw5_pm3148_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
Subjects in the participant group tend to have a positive linear trend
...
to be an increasing trend. It looks like, for many of the subjects, if
we were to add a trend line it would likely be with a slope that is
close to 0. \# Problem 3
